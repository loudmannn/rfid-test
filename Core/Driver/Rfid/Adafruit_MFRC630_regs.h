...
enum mfrc630cmd {
  ...
  MFRC630_CMD_LOADKEY =
      0x02, /**< Reads a 6 int8_t MIFARE key and puts it into KEY BUFFER */
  ...
  MFRC630_CMD_WRITEE2 = 0x08, /**< Gets 1 int8_t from FIFO and writes to EEPROM */
  MFRC630_CMD_WRITEE2PAGE =
      0x09, /**< Gets up to 64 int8_ts from FIFO and writes to EEPROM */
  MFRC630_CMD_READE2 =
  ...
  MFRC630_CMD_STOREKEYE2 =
      0x0F,                   /**< Stores a MIFARE key (6 int8_ts) into EEPROM */
  MFRC630_CMD_READRNR = 0x1C, /**< Copies int8_ts from the random number generator
...
enum ntag_cmd {
  ...
  NTAG_CMD_WRITE = 0xA2,     /**< NTAG-specfiic 4 int8_t write. */
  NTAG_CMD_COMP_WRITE = 0xA0 /**< Mifare Classic 16-int8_t compat. write. */
};
